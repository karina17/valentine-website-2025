...
const CONFIG = {
    ...
    valentineName: "Зарина",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Вы хотите быть моей девушкой? 💝 🙏 ",
    ...
    loveMessages: {
        extreme: "WOOOOW НАСТОЛЬКООО?? 🥰🚀💝",  // Shows when they go past 5000%
        high: "Безумно люблю! 🚀💝",              // Shows when they go past 1000%
        normal: "Очень-очень! 🥰"                           // Shows when they go past 100%
    },
